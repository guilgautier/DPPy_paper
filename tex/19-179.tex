...
\title{
\vspace{-1.6em}
\DPPy: \textcolor{red}{Sampling DPPs or DPP Sampling} with Python}
...
\begin{abstract}%   <- trailing '%' for backward compatibility of .sty file
    ...
    The project is hosted on GitHub\!\footnote{\label{fn:github}\footGitHubDPPy}\,and equipped with an extensive documentation.\hspace{-2pt}\footnote{\label{fn:docs}\footReadTheDocs}
...
\todo{Update ICML workshop papers (GaBaVa19 and DeCaVa19) to NeurIPS}
