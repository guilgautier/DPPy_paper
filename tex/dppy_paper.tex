...
\label{sec:determinantal_point_processes}
  ...
  \label{sub:sampling}
    ...
    \label{ssub:exact_sampling}
      ...
      It is based on the chain rule and a lemma that ensures that a projection $\DPP(\tilde{K})$ generates configurations of $N=\Tr \tilde{K}$ points almost surely. \todo{(rbardenet) stopped here}
