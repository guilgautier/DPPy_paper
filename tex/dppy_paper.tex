...
\jmlrheading{xx}{2018}{xx-xx}{9/18}{xx/xx}{gabava18}{Guillaume Gautier, R\'emi Bardenet, Michal Valko and Guillermo Polito}

% Short headings should be running head and authors last names

\ShortHeadings{\DPPy}{Gautier, Bardenet, Valko and Polito}
\firstpageno{1}
...
\author{\name Guillaume Gautier$^{\dagger*}$ \email g.gautier@inria.fr \\
      \name Guillermo Polito$^{\dagger*}$ \email guillermo.polito@univ-lille.fr\\
       ...
       \name Michal Valko$^{*\ddag}$ \email valkom@deepmind.com\\
       \addr $^\dagger$Univ.\,Lille, CNRS, Centrale Lille, UMR 9189\,--\,CRIStAL, 59651 Villeneuve d'Ascq, France\\
       \addr $^*$SequeL, Inria Lille-Nord Europe, 40 avenue Halley 59650 Villeneuve d'Ascq, France \\ 
