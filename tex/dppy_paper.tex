...
\label{sec:determinantal_point_processes}
  ...
  \label{sub:definition}
    ...
    To understand the interaction in a point process $\calX$, one focuses on the interaction of each cloud of $k$ points (for all $k$). \todo{Give here a simple definition of $\rho_k$, even heuristic, like $\mathbb{P}$(there is a point in each of the $k$ infinitesimal balls $B(x_i,dx_i)$). This will also force you to introduce the reference measure earlier.}
    The corresponding $k$-correlation functions characterize the underlying point process. \todo{ref}
