...
%     We introduce DPPs and the main sampling algorithm; see \citet{HKPV06} for details.
    ...
    \label{sec:definitions}
        ...
        The kernel matrix $\bfK$ is commonly assumed real-symmetric, in which case the existence and unicity of the DPP in \Eqref{eq:inclusion_proba_finite} is equivalent to the condition that its eigenvalues lie in $[0,1]$.
