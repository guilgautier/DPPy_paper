...
%     We introduce DPPs and the main sampling algorithm; see \citet{HKPV06} for details.
    ...
    \label{sec:sampling}
        ...
        \citeauthor{HKPV06}\,\citeyearpar[Theorem\,7]{HKPV06} proved that sampling $\DPP(K)$ can be done in two steps:
        \begin{enumerate}
        ...
        \citeauthor{HKPV06}\,\citeyearpar[Algorithm\,18]{HKPV06} provide a generic projection DPP sampler that we briefly describe.
        ...
        In the continuous case, sampling exactly each conditional that appear in the right hand side of \Eqref{eq:joint_distribution} usually makes use of a rejection sampling mechanism with a tailored proposal.
