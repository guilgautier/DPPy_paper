...
\label{sec:determinantal_point_processes}
  ...
  \label{sub:sampling}
      ...
      \todo{Give here a pointer to the documentation for those who want the formulas} 
      ...
      To conclude, some specific DPPs admit more efficient exact samplers that do not rely on \Eqref{eq:joint_distribution2}, e.g., uniform spanning trees \citep{PrWi98} or eigenvalues of random matrices.
...
\label{sec:conclusion_and_future_work}
  ...
  \DPPy\ is also ready for other contributors to add content and enlarge its scope, e.g., with procedures for learning kernels.
