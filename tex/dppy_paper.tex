...
\label{sec:dppy_in_practice}
  ...
  \DPPy\ strives to handle objects that natural definitions.
  ...
  % and has two main sampling methods .sample_exact() and .sample_mcmc()
  % has an object Finite_DPP which can instantiated through various  parametrizations of the underlying kernel.
  The main method one of 
