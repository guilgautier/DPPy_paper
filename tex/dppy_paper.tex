...
\label{sec:determinantal_point_processes}
  ...
  \label{sub:definition}
    ...
    To understand the interaction in a point process $\calX$, one focuses on the interaction of each cloud of $k$ points (for all $k$). \todo{Give here a simple definition of $\rho_k$.}
