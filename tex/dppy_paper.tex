...
\label{sec:introduction}
  ...
  This prohibitive cost has triggered an effort towards efficient approximate samplers ranging from random approximation \todo{Maybe find a different way of saying it, "random approximation" is too vague} of the kernel \citep{AKFT13} to MCMC samplers \citep{AnGhRe16, LiJeSr16c, GaBaVa17}.\\
...
\label{sec:determinantal_point_processes}
  ...
  \label{sub:definition}
    ...
    \todo{Give here a simple definition of $\rho_k$, even heuristic, like $\mathbb{P}$(there is a point in each of the $k$ infinitesimal balls $B(x_i,dx_i)$). This will also force you to introduce the reference measure earlier.}
    \todo{ref}
