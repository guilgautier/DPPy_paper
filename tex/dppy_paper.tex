...
\label{sec:introduction}
  ...
  This is intractable for large $M$ \citep{Gil14}, as is the case for other kernel machines. \todo{(gg) intractable here to justify approximate sampling, but then we say tractable at the end }
...
\label{sec:determinantal_point_processes}
	...
	We introduce DPPs, and refer to \citet{HKPV06} for more details.
